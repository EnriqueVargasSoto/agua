                ...
                <div class="card card-carousel overflow-hidden h-100 p-0">
                    <div id="carouselExampleCaptions" class="carousel slide h-100" data-bs-ride="carousel">
                        <div class="carousel-inner border-radius-lg h-100">
                            <div class="carousel-item h-100 active" style="background-image: url('admin/assets/img/img-2.jpg'); background-size: cover;">
                            ...
                            <div class="carousel-item h-100" style="background-image: url('admin/assets/img/img-1.jpg'); background-size: cover;">
                                <div class="carousel-caption d-none d-md-block bottom-0 text-start start-0 ms-5">
                                    <div class="icon icon-shape icon-sm bg-white text-center border-radius-md mb-3">
                            ...
                            <div class="carousel-item h-100" style="background-image: url('admin/assets/img/img-3.jpg'); background-size: cover;">
                                <div class="carousel-caption d-none d-md-block bottom-0 text-start start-0 ms-5">
                                    <div class="icon icon-shape icon-sm bg-white text-center border-radius-md mb-3">
                        ...
                        <ul class="list-group list-group-flush">
                            ...
                            <li class="list-group-item px-0">
                                <div class="row align-items-center">
                                    <div class="col-auto d-flex align-items-center">
                                        <a href="javascript:;" class="avatar">
                                        <img class="border-radius-lg" alt="Image placeholder" src="{{ asset('admin/assets/img/team-2.jpg')}}">
                                        </a>
                                    </div>
                                    <div class="col ml-2">
                                        <h6 class="mb-0">
                ...
                <div class="card h-100">
                    <div class="card-header d-flex align-items-center border-bottom py-3">
                        <div class="d-flex align-items-center">
                            <a href="javascript:;">
                                <img src="{{ asset('admin/assets/img/team-4.jpg')}}" class="avatar" alt="profile-image">
                            </a>
                            <div class="mx-3">
                    ...
                    <div class="card-body">
                        ...
                        <img alt="Image placeholder" src="{{ asset('admin/creativetimofficial/public-assets/master/argon-dashboard-pro/assets/img/activity-feed.jpg')}}" class="img-fluid border-radius-lg shadow-lg max-height-500">
                            ...
                            <div class="col-sm-6 d-none d-sm-block">
                                <div class="d-flex align-items-center justify-content-sm-end">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <img alt="Image placeholder" src="{{ asset('admin/assets/img/team-5.jpg')}}" class="">
                                        </a>
                                        <a href="javascript:;" class="avatar avatar-xs rounded-circle" data-toggle="tooltip" data-original-title="Audrey Love">
                                        <img alt="Image placeholder" src="{{ asset('admin/assets/img/team-2.jpg')}}" class="rounded-circle">
                                        </a>
                                        <a href="javascript:;" class="avatar avatar-xs rounded-circle" data-toggle="tooltip" data-original-title="Michael Lewis">
                                        <img alt="Image placeholder" src="{{ asset('admin/assets/img/team-1.jpg')}}" class="rounded-circle">
                                        </a>
                                    </div>
                        ...
                        <div class="mb-1">
                            <div class="d-flex">
                                <div class="flex-shrink-0">
                                    <img alt="Image placeholder" class="avatar rounded-circle" src="{{ asset('admin/assets/img/bruce-mars.jpg')}}">
                                </div>
                            ...
                            <div class="d-flex mt-3">
                                <div class="flex-shrink-0">
                                    <img alt="Image placeholder" class="avatar rounded-circle" src="{{ asset('admin/assets/img/team-5.jpg')}}">
                                </div>
                                <div class="flex-grow-1 ms-3">
                            ...
                            <div class="d-flex mt-4">
                                <div class="flex-shrink-0">
                                    <img alt="Image placeholder" class="avatar rounded-circle me-3" src="{{ asset('admin/assets/img/team-4.jpg')}}">
                                </div>
                        ...
                        <div class="card bg-gradient-danger h-100">
                            <div class="card-body">
                                <div class="row justify-content-between align-items-center">
                                    <div class="col">
                                        <img src="{{ asset('admin/assets/img/logos/bitcoin.jpg')}}" class="w-30 border-radius-md" alt="Image placeholder">
                                    </div>
                                    <div class="col-auto">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <div class="d-flex px-2 py-1">
                                            <div>
                                                <img src="{{ asset('admin/creativetimofficial/public-assets/master/soft-ui-design-system-pro/assets/img/team-2.jpg')}}" class="avatar avatar-sm me-3">
                                            </div>
                                            <div class="d-flex flex-column justify-content-center">
                                                <h6 class="mb-0 text-xs">John Michael</h6>
                                                <p class="text-xs text-secondary mb-0"><a href="https://demos.creative-tim.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="365c595e587655445357425f40531b425f5b1855595b">[email&#160;protected]</a></p>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex px-2 py-1">
                                            <div>
                                                <img src="{{ asset('admin/creativetimofficial/public-assets/master/soft-ui-design-system-pro/assets/img/team-3.jpg')}}" class="avatar avatar-sm me-3">
                                            </div>
                                            <div class="d-flex flex-column justify-content-center">
                                                <h6 class="mb-0 text-xs">Alexa Liras</h6>
                                                <p class="text-xs text-secondary mb-0"><a href="https://demos.creative-tim.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="b1d0ddd4c9d0f1d2c3d4d0c5d8c7d49cc5d8dc9fd2dedc">[email&#160;protected]</a></p>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex px-2 py-1">
                                            <div>
                                                <img src="{{ asset('admin/creativetimofficial/public-assets/master/soft-ui-design-system-pro/assets/img/team-4.jpg')}}" class="avatar avatar-sm me-3">
                                            </div>
                                            <div class="d-flex flex-column justify-content-center">
                                                <h6 class="mb-0 text-xs">Laurent Perrier</h6>
                                                <p class="text-xs text-secondary mb-0"><a href="https://demos.creative-tim.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="aec2cfdbdccbc0daeecddccbcfdac7d8cb83dac7c380cdc1c3">[email&#160;protected]</a></p>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <div class="d-flex px-2 py-1">
                                            ...
                                            <div class="d-flex flex-column justify-content-center">
                                                ...
                                                <p class="text-xs text-secondary mb-0"><a href="https://demos.creative-tim.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="a4c9cdc7ccc5c1c8e4c7d6c1c5d0cdd2c189d0cdc98ac7cbc9">[email&#160;protected]</a></p>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <div class="d-flex px-2 py-1">
                                            ...
                                            <div class="d-flex flex-column justify-content-center">
                                                ...
                                                <p class="text-xs text-secondary mb-0"><a href="https://demos.creative-tim.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="5f2d363c373e2d3b1f3c2d3a3e2b36293a722b3632713c3032">[email&#160;protected]</a></p>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
