      ...
      <div class="col-12">
        <div class="card">
          ...
          <div class="card-header">
            <div class="row">
              <div class="col-6"><h5 class="mb-0">Conceptos</h5></div>
              <div class="col-6">
            ...
            <table class="table table-flush" id="datatable-search">
              ...
              <tbody>
                @foreach ($conceptos as $concepto)
                    <tr>
                      <td class="text-sm font-weight-normal">{{$concepto->concepto}}</td>
                      <td class="text-sm font-weight-normal">{{$concepto->valor}}</td>
                      <td class="text-sm font-weight-normal">
                        <a href="#editModal{{$concepto->id}}" data-bs-toggle="modal" class="btn btn-info">Editar</a>
                        @if ($concepto->tipo == 'editable')
                        <a href="{{ route('elimina.concepto', $concepto->id)}}" class="btn btn-danger">Eliminar</a>
                        @endif
