            ...
            <div class="row">
                <div class="big-column col-xl-4 col-lg-3 col-md-12">
                    <div class="footer-column about-widget">
                        ...
                        <p class="phone-num"><span>Llámanos </span><a href="thebeehost%40support.html">987 654 321</a></p>
                        <p class="address">Direccion tal<br> 3051, Cajamarca. <br><a href="mailto:support@superio.com" class="email">ejemplo@email.com</a></p>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="footer-column col-lg-3 col-md-6 col-sm-12">
                            <div class="footer-widget links-widget">
                                <h4 class="widget-title">Titulo1</h4>
                        ...
                        <div class="footer-column col-lg-5 col-md-6 col-sm-12">
                            <div class="footer-widget links-widget">
                                <h4 class="widget-title">Titulo2</h4>
                        ...
                        <div class="footer-column col-lg-4 col-md-12 col-sm-12">
                            <div class="footer-widget">
                                <h4 class="widget-title">Titulo3</h4>
                                <div class="widget-content">
                                    <div class="newsletter-form">
                                        <div class="text">No enviamos spam así que no te preocupes.</div>
